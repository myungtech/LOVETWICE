...
import twentyOnce.brd.dto.QADto;

public interface QADao {
	public ArrayList<QADto> list(int rowStart, int rowEnd, String searchKeyword, String string);
	...
	public QADto contentView(String num);
