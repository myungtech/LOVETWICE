...
import twentyOnce.brd.dto.TODto;

public interface TODao {
	public ArrayList<TODto> list(int rowStart, int rowEnd, String searchKeyword, String string);
	...
	public TODto contentView(String num);
