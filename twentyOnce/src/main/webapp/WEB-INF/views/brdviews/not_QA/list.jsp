...
<script src='https://code.jquery.com/jquery-3.3.1.min.js'></script>
		<script type="text/javascript">
			...
			function fn_list(page) {
				...
				window.location.href="/twentyOnce/brdviews/not_QA/list?curPage="+page+"&searchType="+searchType+"&searchkw="+searchKeyword;
				
			}
			function fn_contentview(not_num,curPage){
				alert("상세페이지 값 전달 되나 ??");
				window.location.href="/twentyOnce/brdviews/not_QA/content_view?curPage="+curPage+"&not_num="+not_num+"&searchType="+"${paramMap.searchType}"+"&searchkw="+"${paramMap.searchkw}";
			}
			...
			function fn_searchCC() {
				...
				window.location.href="/twentyOnce/brdviews/not_QA/list?curPage=1&searchType="+searchType+"&searchkw="+searchKeyword;	
			}
		</script>
</head>
<body>
